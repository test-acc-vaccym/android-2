...
public class AlertView {
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style,AdapterView.OnItemClickListener onItemClickListener){
    ...
    */
    ...
    public AlertView setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
