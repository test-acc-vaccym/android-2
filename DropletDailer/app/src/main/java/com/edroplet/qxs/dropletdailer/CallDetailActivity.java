...
import com.edroplet.qxs.dropletdailer.util.CallUtil;
import com.edroplet.qxs.dropletdailer.util.ClipboardUtils;
import com.edroplet.qxs.dropletdailer.ContactPhotoManager;
import com.edroplet.qxs.dropletdailer.ContactPhotoManager.DefaultImageRequest;
import com.edroplet.qxs.dropletdailer.util.GeoUtil;
import com.edroplet.qxs.dropletdailer.compat.CompatUtils;
import com.edroplet.qxs.dropletdailer.interactions.TouchPointManager;
import com.edroplet.qxs.dropletdailer.preference.ContactsPreferences;
import com.edroplet.qxs.dropletdailer.testing.NeededForTesting;
import com.edroplet.qxs.dropletdailer.util.StatisticsUtil;
import com.edroplet.qxs.dropletdailer.util.UriUtils;
import com.edroplet.qxs.dropletdailer.calllog.CallDetailHistoryAdapter;
import com.edroplet.qxs.dropletdailer.calllog.CallLogAsyncTaskUtil;
import com.edroplet.qxs.dropletdailer.calllog.CallLogAsyncTaskUtil.CallLogAsyncTaskListener;
import com.edroplet.qxs.dropletdailer.calllog.CallTypeHelper;
import com.edroplet.qxs.dropletdailer.calllog.ContactInfoHelper;
import com.edroplet.qxs.dropletdailer.calllog.PhoneAccountUtils;
import com.edroplet.qxs.dropletdailer.compat.FilteredNumberCompat;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberAsyncQueryHandler;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberAsyncQueryHandler.OnCheckBlockedListener;
import com.edroplet.qxs.dropletdailer.filterednumber.BlockNumberDialogFragment;
import com.edroplet.qxs.dropletdailer.filterednumber.FilteredNumbersUtil;
import com.edroplet.qxs.dropletdailer.logging.InteractionEvent;
import com.edroplet.qxs.dropletdailer.logging.Logger;
import com.edroplet.qxs.dropletdailer.util.DialerUtils;
import com.edroplet.qxs.dropletdailer.util.IntentUtil.CallIntentBuilder;
import com.edroplet.qxs.dropletdailer.util.PhoneNumberUtil;
...
public class CallDetailActivity extends AppCompatActivity
    ...
    private CallLogAsyncTaskListener mCallLogAsyncTaskListener = new CallLogAsyncTaskListener() {
        ...
        public void onGetCallDetails(PhoneCallDetails[] details) {
            ...
            String displayNumberStr = displayNumber.toString();
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) displayNumberStr = mBidiFormatter.unicodeWrap(displayNumber.toString(), TextDirectionHeuristics.LTR);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) mBidiFormatter = BidiFormatter.getInstance();
        mContext = this;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) mQuickContactBadge.setOverlay(null);
        if (CompatUtils.hasPrioritizedMimeType() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
