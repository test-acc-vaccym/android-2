...
package com.edroplet.qxs.dropletdailer.calllog;
...
import com.edroplet.qxs.dropletdailer.util.ContactsUtils;
import com.edroplet.qxs.dropletdailer.compat.CompatUtils;
import com.edroplet.qxs.dropletdailer.compat.PhoneNumberUtilsCompat;
...
import com.edroplet.qxs.dropletdailer.DialtactsActivity;
import com.edroplet.qxs.dropletdailer.PhoneCallDetails;
import com.edroplet.qxs.dropletdailer.R;
import com.edroplet.qxs.dropletdailer.calllog.calllogcache.CallLogCache;
import com.edroplet.qxs.dropletdailer.contactinfo.ContactInfoCache;
import com.edroplet.qxs.dropletdailer.contactinfo.ContactInfoCache.OnContactInfoChangedListener;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberAsyncQueryHandler;
import com.edroplet.qxs.dropletdailer.database.VoicemailArchiveContract;
import com.edroplet.qxs.dropletdailer.filterednumber.BlockNumberDialogFragment.Callback;
...
public class CallLogAdapter extends GroupingListAdapter
     ...
     *  put into the primary call groups in {@link com.edroplet.qxs.dropletdailer.calllog.CallLogGroupBuilder},
    ...
    public void onUnblockedNumber( String number, String countryIso) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){String cacheKey = PhoneNumberUtils.formatNumberToE164(number, countryIso);
        if (!TextUtils.isEmpty(cacheKey)) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) Trace .beginSection("onBindViewHolder: " + position);
     ...
     * populated in {@link com.edroplet.qxs.dropletdailer.calllog.CallLogGroupBuilder}.
     *
