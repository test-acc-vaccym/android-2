...
import com.edroplet.qxs.dropletdailer.DialerApplication1;
...
import com.edroplet.qxs.dropletdailer.compat.TelecomManagerUtil;
...
import com.edroplet.qxs.dropletdailer.database.FilteredNumberContract.FilteredNumber;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberContract.FilteredNumberColumns;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberContract.FilteredNumberSources;
import com.edroplet.qxs.dropletdailer.database.FilteredNumberContract.FilteredNumberTypes;
...
import com.edroplet.qxs.dropletdailer.filterednumber.BlockedNumbersMigrator;
import com.edroplet.qxs.dropletdailer.filterednumber.BlockedNumbersSettingsActivity;
import com.edroplet.qxs.dropletdailer.filterednumber.MigrateBlockedNumbersDialogFragment;
 ...
 * {@link com.edroplet.qxs.dropletdailer.database.FilteredNumberContract} and using
...
public class FilteredNumberCompat {
    ...
    public static ContentValues newBlockNumberContentValues(String number,
        ...
        if (!useNewFiltering()) {
            if (e164Number == null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
