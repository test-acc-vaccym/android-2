...
import com.edroplet.qxs.dropletdailer.calllog.CallLogNotificationsService;
import com.edroplet.qxs.dropletdailer.calllog.ContactInfo;
import com.edroplet.qxs.dropletdailer.util.ContactsUtils;
import com.edroplet.qxs.dropletdailer.util.PhoneNumberHelper;
import com.edroplet.qxs.dropletdailer.DialtactsActivity;
import com.edroplet.qxs.dropletdailer.R;
import com.edroplet.qxs.dropletdailer.calllog.CallLogNotificationsHelper.NewCall;
import com.edroplet.qxs.dropletdailer.contactinfo.ContactPhotoLoader;
import com.edroplet.qxs.dropletdailer.compat.UserManagerCompat;
...
public class MissedCallNotifier {
    ...
    public void updateMissedCallNotification(int count, String number) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) publicBuilder.setColor(mContext.getResources().getColor(R.color.dialer_theme_color));
