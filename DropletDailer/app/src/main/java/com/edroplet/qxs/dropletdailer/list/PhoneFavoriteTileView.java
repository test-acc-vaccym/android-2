...
import com.edroplet.qxs.dropletdailer.list.ContactEntry;
import com.edroplet.qxs.dropletdailer.list.ContactTileView;
import com.edroplet.qxs.dropletdailer.R;

/**
 * A light version of the {@link com.edroplet.qxs.dropletdailer.list.ContactTileView} that is used in
    ...
    protected void onFinishInflate() {
        ...
        setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                view.startDrag(EMPTY_CLIP_DATA, new DragShadowBuilder(),
