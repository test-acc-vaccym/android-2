...
package com.edroplet.qxs.dropletdailer.voicemail;
...
import com.edroplet.qxs.dropletdailer.util.AsyncTaskExecutor;
import com.edroplet.qxs.dropletdailer.util.AsyncTaskExecutors;
import com.edroplet.qxs.dropletdailer.io.MoreCloseables;
 ...
 * {@link 1CallLogFragment} and {@link1 CallLogAdapter}.
 * <p>
 * This controls a single {@link com.edroplet.qxs.dropletdailer.voicemail.VoicemailPlaybackLayout}. A single
...
public class VoicemailPlaybackPresenter implements MediaPlayer.OnPreparedListener,
    ...
    protected VoicemailPlaybackPresenter(Activity activity) {
        ...
        if ( Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP &&powerManager.isWakeLockLevelSupported(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK)) {
