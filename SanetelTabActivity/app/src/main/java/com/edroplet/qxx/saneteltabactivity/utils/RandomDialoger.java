...
public class RandomDialoger {
    public static NiftyDialogBuilder dialogBuilder;
    public static boolean onConfirm(Context context, String message, View.OnClickListener listener){
        ...
        dialogBuilder
                ...
                .withDuration(mContext.getResources().getInteger(R.integer.operate_confirm_animate_time))              //动画显现的时间（时间长就类似放慢动作）
                // 基本设置
                .withTitle(mContext.getResources().getString(R.string.operate_confirm_title))         //设置对话框标题
                ...
                .withButton1Text(mContext.getResources().getString(R.string.operate_confirm_ok))             //设置按钮1的文本
                .withButton2Text(mContext.getResources().getString(R.string.operate_confirm_cancel))         //设置按钮2的文本
