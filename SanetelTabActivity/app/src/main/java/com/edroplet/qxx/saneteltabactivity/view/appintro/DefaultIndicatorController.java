...
class DefaultIndicatorController implements com.edroplet.qxx.saneteltabactivity.view.appintro.IndicatorController {
    ...
    public View newInstance(@NonNull Context context) {
        mContext = context;
        mDotLayout = (LinearLayout) View.inflate(context, R.layout.app_intro_default_indicator, null);
