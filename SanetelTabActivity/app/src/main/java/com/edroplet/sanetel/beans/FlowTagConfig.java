...
public class FlowTagConfig {
    ...
    public FlowTagConfig(Context context, AttributeSet attrs){
        ...
        try {
            lineSpacing = a.getDimensionPixelSize(R.styleable.CustomButton_lineSpacing, DEFAULT_LINE_SPACING);
            tagSpacing = a.getDimensionPixelSize(R.styleable.CustomButton_tagSpacing, DEFAULT_TAG_SPACING);
            columnSize = a.getInteger(R.styleable.CustomButton_columnSize, DEFAULT_FIXED_COLUMN_SIZE);
            isFixed = a.getBoolean(R.styleable.CustomButton_isFixed,false);
        } finally {
            a.recycle();
        }
    }
