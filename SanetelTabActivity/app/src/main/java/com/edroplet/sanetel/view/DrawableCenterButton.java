...
public class DrawableCenterButton extends RelativeLayout {
    ...
    private com.edroplet.sanetel.view.custom.CustomTextView textView;
    ...
    public DrawableCenterButton(Context context, AttributeSet attrs) {
        ...
        this.textView = (com.edroplet.sanetel.view.custom.CustomTextView)findViewById(R.id.drawable_text_text_view);
