...
import com.edroplet.sanetel.view.appintro.AppIntro2;

/**
 * A controller that is used to provide custom indicator implementations and to control their behaviour.
 * This is used for {@link com.edroplet.sanetel.view.appintro.AppIntro#setCustomIndicator(IndicatorController)} and
