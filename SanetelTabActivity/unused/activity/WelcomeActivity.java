...
import com.edroplet.sanetel.adapters.WelcomePageAdapter;
import com.edroplet.sanetel.utils.CustomSP;


/**
 * An example full-screen activity that shows and hides the system UI (i.e.
 * status bar and main_navigation/system bar) with user interaction.
 */
public class WelcomeActivity extends AppCompatActivity  implements OnPageChangeListener {
    ...
    private com.edroplet.sanetel.view.custom.CustomButton btnstarthome;
    ...
    private void initViews() {
        ...
        views.add(inflater.inflate(R.layout.welcome_check_device, null));
        views.add(inflater.inflate(R.layout.welcome_fix_device, null));
        views.add(guideFour);
        // 初始化Adapter
