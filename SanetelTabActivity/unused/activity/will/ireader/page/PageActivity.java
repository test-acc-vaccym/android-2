...
public class PageActivity extends BaseActivity implements Animation.AnimationListener{
    ...
    private void iniBottomSheetMenu(){
        ...
        //change progress
        progressBar = (CustomSeekBar) findViewById(R.id.reading_activity_seek_bar);
    ...
    public void changeSeekbarColor(CustomSeekBar s, int color)
    {
