...
public class RewardOffersSample extends Activity {
		...
		findViewById(R.id.btn_award).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						// 奖励积分示例
						YoumiPointsManager.awardPoints(RewardOffersSample.this,
								10);
		...
		findViewById(R.id.btn_spend).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						// 消费积分示例
						YoumiPointsManager.spendPoints(RewardOffersSample.this,
								10);
	...
	void showPoints() {
		try {
			// 查询积分示例
			tvPoints.setText(Integer.toString(YoumiPointsManager
					.queryPoints(this)));
