...
public class ProgressIndicatorController implements com.edroplet.qxx.saneteltabactivity.view.appintro.IndicatorController {
    ...
    public View newInstance(@NonNull Context context) {
        mProgressBar = (ProgressBar) View.inflate(context, R.layout.app_intro_progress_indicator, null);
